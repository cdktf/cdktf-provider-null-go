...
import (
	...
	"github.com/cdktf/cdktf-provider-null-go/null/v10/resource/internal"
...
func Resource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (r *jsiiProxy_Resource) ImportFrom(id *string, provider cdktf.TerraformProvider) {
