...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DataNullDataSource)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "hasComputedDefault", GoGetter: "HasComputedDefault"},
			_jsii_.MemberProperty{JsiiProperty: "hasComputedDefaultInput", GoGetter: "HasComputedDefaultInput"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-null.DataNullDataSourceConfig",
		reflect.TypeOf((*DataNullDataSourceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-null.NullProvider",
		reflect.TypeOf((*NullProvider)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-null.NullProviderConfig",
		reflect.TypeOf((*NullProviderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-null.ResourceConfig",
