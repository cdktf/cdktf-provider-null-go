...
import (
	...
	"github.com/cdktf/cdktf-provider-null-go/null/v10/datanulldatasource/internal"
...
func DataNullDataSource_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateDataNullDataSource_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataNullDataSource) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (d *jsiiProxy_DataNullDataSource) ToHclTerraform() interface{} {
	var returns interface{}
