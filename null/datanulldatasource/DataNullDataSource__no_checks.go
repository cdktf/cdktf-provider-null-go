...
func validateDataNullDataSource_GenerateConfigForImportParameters(scope constructs.Construct, importToId *string, importFromId *string) error {
	return nil
}
...
func validateDataNullDataSource_IsTerraformDataSourceParameters(x interface{}) error {
	return nil
}

func validateDataNullDataSource_IsTerraformElementParameters(x interface{}) error {
	return nil
}
